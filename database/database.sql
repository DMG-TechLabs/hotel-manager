...
INSERT ALL
    INTO ROOM_TYPE (TYPE_ID, TYPE_NAME) VALUES (0, 'Single')
    INTO ROOM_TYPE (TYPE_ID, TYPE_NAME) VALUES (1, 'Double')
    INTO ROOM_TYPE (TYPE_ID, TYPE_NAME) VALUES (2, 'Family')
    INTO ROOM_TYPE (TYPE_ID, TYPE_NAME) VALUES (3, 'Suite')
    INTO ROOM_TYPE (TYPE_ID, TYPE_NAME) VALUES (4, 'Deluxe')
SELECT * FROM DUAL;

-- Insert Data into USER_TYPE
INSERT ALL
    INTO USER_TYPE (USER_TYPE_ID, USER_TYPE_NAME) VALUES (0, 'SYSTEM MANAGER')
    INTO USER_TYPE (USER_TYPE_ID, USER_TYPE_NAME) VALUES (1, 'HOTEL MANAGER')
    INTO USER_TYPE (USER_TYPE_ID, USER_TYPE_NAME) VALUES (2, 'HOTEL STAFF')
    INTO USER_TYPE (USER_TYPE_ID, USER_TYPE_NAME) VALUES (3, 'GUEST')
SELECT * FROM DUAL;
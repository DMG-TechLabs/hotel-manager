...
public class ViewCustomersFrame extends javax.swing.JFrame {
    ...
    String [] columnNames = {"customer_id", "First Name", "Last Name", "Phone", "Email"};
    ...
    for(int i = 0; i < customerList.size(); i++){
        ...
        Object [] row = {
            customerRow.getId(),
            customerRow.getFirstName(),
            customerRow.getLastName(),
            customerRow.getPhone(),
            customerRow.getEmail()
        };
        model.addRow(row);
    }
